...
import control.InputSVControl;
import model.DanhSachSV;
import model.InputToFile;
import model.OutputToFile;
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 4:
				...
				OutputToFile.outputToFile(fileName, dssv);
				break;
			case 5:
				System.out.print("Nhap Ten file: ");
				fileName = sc.nextLine();
				dssv = InputToFile.inputToFile(fileName);
				break;
			default:
				System.err.println("khong co lua chon");
				break;
